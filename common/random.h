...
namespace EQ {
	...
	public:
		...
		// Normal Distribution, std = range/2
		double BoundedNormalReal(double base, double range)
		{
			std::normal_distribution<> d(base,range/2.0);
			return EQ::Clamp(base-range, d(m_gen), base+range); // [low, high)
		}
