...
struct LootLockout_Struct {
	char name[64];
	uint32 unix_expiry_timestamp;
};
...
//custom struct for merc characters
...
/*0724*/	float	NPCZoneDifficulty;
/*0728*/	uint32	underworld_teleport_index; // > 0 teleports w/ zone point index, invalid succors, if this value is 0, it prevents you from running off edges that would end up underworld
/*0732*/
};
...
/*00*/ int32		aapoint_assigned;					// Total AAs Spent
...
/*000*/ uint32	unknown000;
/*004*/ uint32  unknown004; //0xff
/*008*/ char	unknown008; //0xff
/*008*/ char	unknown009; //0xff
