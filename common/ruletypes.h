...
RULE_INT(Character, TradeskillUpTailoring, 2, "Tailoring skillup rate adjust. Lower is faster")
RULE_BOOL(Character, MarqueeHPUpdates, false, "Will show Health % in center of screen < 100%")
RULE_INT(Character, IksarCommonTongue, 100, "100 By default (live-like?)")
RULE_INT(Character, OgreCommonTongue, 100, "100 By default (live-like?)")
RULE_INT(Character, TrollCommonTongue, 100, "100 By default (live-like?)")
...
RULE_INT(Skills, SwimmingStartValue, 400, "Start value of swimming skill")
RULE_BOOL(Skills, TrainSenseHeading, false, "Switch whether SenseHeading is trained by use")
RULE_INT(Skills, SenseHeadingStartValue, 400, "Start value of sense heading skill")
...
RULE_BOOL(World, EnableLevelBroadcasts, false, "Enable Level Broadcasts (for events)")
...
RULE_INT(World, LevelToApplyCRC, 15, "")
