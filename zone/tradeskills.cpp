...
void Object::HandleCombine(Client* user, const NewCombine_Struct* in_combine, Object *worldo)
{
	...
	if (container->GetItem() && container->GetItem()->EdgeBagType == EQ::item::EdgeBagType::EdgeBagSpellCraftingTome) { // Spell Crafting Tome
		int ids[4];
		for(int i = 0; i < 4; i++)
		{
			if(container->GetItem(i))
			{
				ids[i] = container->GetItem(i)->GetItem()->ID;
				if(ids[i] < 199900 || ids[i] >= 200000)
				{
		...
		for (int i = 0; i < 4 - 1; i++)
		{
			for (int j = i + 1; j < 4; j++)
			{
				if (i != j && ids[i] == ids[j])
				{
					std::string msg = "Spells may not have duplicate runes!";
					user->Message(Chat::Emote, msg.c_str());
					auto outapp = new EQApplicationPacket(OP_TradeSkillCombine, 0);
					user->QueuePacket(outapp);
					safe_delete(outapp);
					return;
		...
		for (uint8 i = EQ::invbag::SLOT_BEGIN; i < EQ::invtype::WORLD_SIZE; i++) {
			EQ::ItemInstance* inst = container->GetItem(i);
			if (inst) {
				if(inst->GetCharges() > 1)
				{
					inst->SetCharges(inst->GetCharges() - 1);
					user->SendLootItemInPacket(inst, EQ::InventoryProfile::CalcSlotId(in_combine->container_slot, i));
					database.SaveInventory(user->CharacterID(), inst, EQ::InventoryProfile::CalcSlotId(in_combine->container_slot, i));
				}
				else
				{
		...
		bool first = true;
		std::string query = "SELECT id FROM spells_new WHERE";
		for(int i = 0; i < 4; i++)
		{
			switch(ids[i])
			{
				...
				case 199932:
					if(!first) { query +=" AND"; }
					query += " (classes1 between 0 and 10 OR classes2 between 0 and 10 OR classes3 between 0 and 10 OR classes4 between 0 and 10 OR classes5 between 0 and 10 OR classes6 between 0 and 10 OR classes7 between 0 and 10 OR classes8 between 0 and 10 OR classes9 between 0 and 10 OR classes10 between 0 and 10 OR classes11 between 0 and 10 OR classes12 between 0 and 10 OR classes13 between 0 and 10 OR classes14 between 0 and 10 OR classes15 between 0 and 10 OR classes16 between 0 and 10)";
					break;
				case 199933:
					if(!first) { query +=" AND"; }
					query += " (classes1 between 11 and 20 OR classes2 between 11 and 20 OR classes3 between 11 and 20 OR classes4 between 11 and 20 OR classes5 between 11 and 20 OR classes6 between 11 and 20 OR classes7 between 11 and 20 OR classes8 between 11 and 20 OR classes9 between 11 and 20 OR classes10 between 11 and 20 OR classes11 between 11 and 20 OR classes12 between 11 and 20 OR classes13 between 11 and 20 OR classes14 between 11 and 20 OR classes15 between 11 and 20 OR classes16 between 11 and 20)";
					break;
				case 199934:
					if(!first) { query +=" AND"; }
					query += " (classes1 between 21 and 30 OR classes2 between 21 and 30 OR classes3 between 21 and 30 OR classes4 between 21 and 30 OR classes5 between 21 and 30 OR classes6 between 21 and 30 OR classes7 between 21 and 30 OR classes8 between 21 and 30 OR classes9 between 21 and 30 OR classes10 between 21 and 30 OR classes11 between 21 and 30 OR classes12 between 21 and 30 OR classes13 between 21 and 30 OR classes14 between 21 and 30 OR classes15 between 21 and 30 OR classes16 between 21 and 30)";
					break;
				case 199935:
					if(!first) { query +=" AND"; }
					query += " (classes1 between 31 and 40 OR classes2 between 31 and 40 OR classes3 between 31 and 40 OR classes4 between 31 and 40 OR classes5 between 31 and 40 OR classes6 between 31 and 40 OR classes7 between 31 and 40 OR classes8 between 31 and 40 OR classes9 between 31 and 40 OR classes10 between 31 and 40 OR classes11 between 31 and 40 OR classes12 between 31 and 40 OR classes13 between 31 and 40 OR classes14 between 31 and 40 OR classes15 between 31 and 40 OR classes16 between 31 and 40)";
					break;
				case 199936:
					if(!first) { query +=" AND"; }
					query += " (classes1 between 41 and 50 OR classes2 between 41 and 50 OR classes3 between 41 and 50 OR classes4 between 41 and 50 OR classes5 between 41 and 50 OR classes6 between 41 and 50 OR classes7 between 41 and 50 OR classes8 between 41 and 50 OR classes9 between 41 and 50 OR classes10 between 41 and 50 OR classes11 between 41 and 50 OR classes12 between 41 and 50 OR classes13 between 41 and 50 OR classes14 between 41 and 50 OR classes15 between 41 and 50 OR classes16 between 41 and 50)";
					break;
				case 199937:
					if(!first) { query +=" AND"; }
					query += " (classes1 between 51 and 60 OR classes2 between 51 and 60 OR classes3 between 51 and 60 OR classes4 between 51 and 60 OR classes5 between 51 and 60 OR classes6 between 51 and 60 OR classes7 between 51 and 60 OR classes8 between 51 and 60 OR classes9 between 51 and 60 OR classes10 between 51 and 60 OR classes11 between 51 and 60 OR classes12 between 51 and 60 OR classes13 between 51 and 60 OR classes14 between 51 and 60 OR classes15 between 51 and 60 OR classes16 between 51 and 60)";
					break;
				case 199938:
					if(!first) { query +=" AND"; }
					query += " (classes1 between 61 and 70 OR classes2 between 61 and 70 OR classes3 between 61 and 70 OR classes4 between 61 and 70 OR classes5 between 61 and 70 OR classes6 between 61 and 70 OR classes7 between 61 and 70 OR classes8 between 61 and 70 OR classes9 between 61 and 70 OR classes10 between 61 and 70 OR classes11 between 61 and 70 OR classes12 between 61 and 70 OR classes13 between 61 and 70 OR classes14 between 61 and 70 OR classes15 between 61 and 70 OR classes16 between 61 and 70)";
					break;
				case 199939:
					if(!first) { query +=" AND"; }
					query += " (classes1 between 71 and 80 OR classes2 between 71 and 80 OR classes3 between 71 and 80 OR classes4 between 71 and 80 OR classes5 between 71 and 80 OR classes6 between 71 and 80 OR classes7 between 71 and 80 OR classes8 between 71 and 80 OR classes9 between 71 and 80 OR classes10 between 71 and 80 OR classes11 between 71 and 80 OR classes12 between 71 and 80 OR classes13 between 71 and 80 OR classes14 between 71 and 80 OR classes15 between 71 and 80 OR classes16 between 71 and 80)";
					break;
				case 199940:
					if(!first) { query +=" AND"; }
					query += " (classes1 between 81 and 90 OR classes2 between 81 and 90 OR classes3 between 81 and 90 OR classes4 between 81 and 90 OR classes5 between 81 and 90 OR classes6 between 81 and 90 OR classes7 between 81 and 90 OR classes8 between 81 and 90 OR classes9 between 81 and 90 OR classes10 between 81 and 90 OR classes11 between 81 and 90 OR classes12 between 81 and 90 OR classes13 between 81 and 90 OR classes14 between 81 and 90 OR classes15 between 81 and 90 OR classes16 between 81 and 90)";
					break;
				case 199941:
					if(!first) { query +=" AND"; }
					query += " (classes1 between 91 and 253 OR classes2 between 91 and 253 OR classes3 between 91 and 253 OR classes4 between 91 and 253 OR classes5 between 91 and 253 OR classes6 between 91 and 253 OR classes7 between 91 and 253 OR classes8 between 91 and 253 OR classes9 between 91 and 253 OR classes10 between 91 and 253 OR classes11 between 91 and 253 OR classes12 between 91 and 253 OR classes13 between 91 and 253 OR classes14 between 91 and 253 OR classes15 between 91 and 253 OR classes16 between 91 and 253)";
					break;
			}
			if(first && ids[i] != 199942 && ids[i] != 199943 && ids[i] != 199944) 
			{
				first = false;
			}
		}

		auto results = database.QueryDatabase(query + StringFormat(" AND classes0 <= %i order by RAND() LIMIT 1", user->GetLevel()));
		if (!results.Success())
		{
			user->TryForceStack(199944, 1);
			std::string msg = "You have salvaged a Rune of Talcode from your catastrophic fuckup!";
			user->Message(Chat::Loot, msg.c_str());
		}
		if (results.RowCount() < 1)
		{
			user->TryForceStack(199942, 1);
			std::string msg = "You have salvaged a Rune of Void from your waste of runes!";
			user->Message(Chat::Loot, msg.c_str());
		}
		else if (results.RowCount() == 1)
		{
			...
			if(user->FindSpellBookSlotBySpellID(spellid) >= 0)
			{
				int items[42];
				int current = 0;
				int level = 255;
			...
			{
				user->ScribeSpell(spellid, user->GetNextAvailableSpellBookSlot(0), true);

				std::string msg = StringFormat("You have learned a new spell! (%s)", spells[spellid].name);
				user->Message(Chat::Experience, msg.c_str());
				user->SendMarqueeMessage(15, 510, 1, 1, 3000, msg.c_str());
			}
		}
		auto outapp = new EQApplicationPacket(OP_TradeSkillCombine, 0);
		user->QueuePacket(outapp);
...
void Object::HandleAutoCombine(Client* user, const RecipeAutoCombine_Struct* rac) {
	...
	if(count != needcount)
	{
		...
		for (auto it = MissingItems.begin(); it != MissingItems.end(); ++it) {
			EQ::ItemData item = database.GetItem(*it);
			if(item.ID)
...
bool Client::TradeskillExecute(DBTradeskillRecipe_Struct *spec) {
	...
	int32 higher_from_int_wis = (GetINT() > GetWIS()) ? GetINT() : GetWIS();
	int32 bonusstat = (higher_from_int_wis > thirdstat) ? EQ::Clamp(higher_from_int_wis, 150, 250) : EQ::Clamp(thirdstat, 150, 250);
	...
	if(spec->nofail) {
		...
		chance = 100.0f + (float(user_skill - spec->trivial) / 40.0f);
	...
	/* Tradeskill Fail */
		...
		int SalvageChance = user_skill / 10 + aabonuses.SalvageChance + itembonuses.SalvageChance + spellbonuses.SalvageChance;
...
void Client::CheckIncreaseTradeskill(int16 bonusstat, int16 stat_modifier, float skillup_modifier, uint16 success_modifier, EQ::skills::SkillType tradeskill)
{
	...
	chance_stage2 = mod_tradeskill_skillup(chance_stage2) / success_modifier;

	if(chance_stage2 < 1.0f)
		chance_stage2 = 1.0f;

	if (chance_stage2 > zone->random.Real(0, 100)) {
		//Only if stage1 and stage2 succeeded you get a skillup.
		SetSkill(tradeskill, current_raw_skill + 1);
		AddEXP(200 * (current_raw_skill + 1), 0);
	...
	uint32 char_id, DBTradeskillRecipe_Struct *spec)
{
	...
	for (uint8 i = 0; i < 10; i++) { // <watch> TODO: need to determine if this is bound to world/item container size
		...
		EQ::ItemData item = database.GetItem(inst->GetID());
        if (!item.ID)
            continue;
	...
	for (auto row = results.begin(); row != results.end(); ++row) {
		...
		for (int x = EQ::invbag::SLOT_BEGIN; x < EQ::invtype::WORLD_SIZE; x++) {
			...
			EQ::ItemData item = GetItem(inst->GetItem()->ID);
            if (!item.ID)
                continue;
...
bool Client::CanIncreaseTradeskill(EQ::skills::SkillType tradeskill) {
	...
	if (rawskill >= GetLevel() * 8)
	{
		Message(Chat::Red, "Unable to increase skill further. Increase character level to progress further.");
		return false;
	}
