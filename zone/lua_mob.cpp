...
void Lua_Mob::GotoBind(int bind_num) {
	Lua_Safe_Call_Void();
	self->GoToBind(bind_num);
}
...
int64 Lua_Mob::GetMaxMana() {
	Lua_Safe_Call_Int();
	return self->GetMaxMana();
}

int64 Lua_Mob::GetMana() {
	Lua_Safe_Call_Int();
	return self->GetMana();
}

int64 Lua_Mob::SetMana(int64 mana) {
	Lua_Safe_Call_Int();
...
int64 Lua_Mob::GetSTR() {
	Lua_Safe_Call_Int();
	return self->GetSTR();
}

int64 Lua_Mob::GetSTA() {
	Lua_Safe_Call_Int();
	return self->GetSTA();
}

int64 Lua_Mob::GetDEX() {
	Lua_Safe_Call_Int();
	return self->GetDEX();
}

int64 Lua_Mob::GetAGI() {
	Lua_Safe_Call_Int();
	return self->GetAGI();
}

int64 Lua_Mob::GetINT() {
	Lua_Safe_Call_Int();
	return self->GetINT();
}

int64 Lua_Mob::GetWIS() {
	Lua_Safe_Call_Int();
	return self->GetWIS();
}

int64 Lua_Mob::GetCHA() {
	Lua_Safe_Call_Int();
	return self->GetCHA();
}
...
int64 Lua_Mob::GetMaxSTR() {
	Lua_Safe_Call_Int();
	return self->GetMaxSTR();
}

int64 Lua_Mob::GetMaxSTA() {
	Lua_Safe_Call_Int();
	return self->GetMaxSTA();
}

int64 Lua_Mob::GetMaxDEX() {
	Lua_Safe_Call_Int();
	return self->GetMaxDEX();
}

int64 Lua_Mob::GetMaxAGI() {
	Lua_Safe_Call_Int();
	return self->GetMaxAGI();
}

int64 Lua_Mob::GetMaxINT() {
	Lua_Safe_Call_Int();
	return self->GetMaxINT();
}

int64 Lua_Mob::GetMaxWIS() {
	Lua_Safe_Call_Int();
	return self->GetMaxWIS();
}

int64 Lua_Mob::GetMaxCHA() {
	Lua_Safe_Call_Int();
...
Lua_Mob Lua_Mob::GetHateSecond(Lua_Mob skip) {
	Lua_Safe_Call_Class(Lua_Mob);
	return Lua_Mob(self->GetSecondaryHate(skip));
}
...
void Lua_Mob::WipeHateList(bool npc_only) {
	Lua_Safe_Call_Void();
	self->WipeHateList(npc_only);
}
...
int64 Lua_Mob::CheckAggroAmount(int spell_id) {
	Lua_Safe_Call_Int();
	return self->CheckAggroAmount(spell_id, nullptr);
}

int64 Lua_Mob::CheckAggroAmount(int spell_id, bool is_proc) {
	Lua_Safe_Call_Int();
	return self->CheckAggroAmount(spell_id, nullptr, is_proc);
}

int64 Lua_Mob::CheckHealAggroAmount(int spell_id) {
	Lua_Safe_Call_Int();
	return self->CheckHealAggroAmount(spell_id, nullptr);
}

int64 Lua_Mob::CheckHealAggroAmount(int spell_id, uint64 heal_possible) {
	Lua_Safe_Call_Int();
...
void Lua_Mob::DoSpecialAttackDamage(Lua_Mob other, int skill, int64 max_damage) {
	Lua_Safe_Call_Void();
	self->DoSpecialAttackDamage(other, static_cast<EQ::skills::SkillType>(skill), max_damage);
}

void Lua_Mob::DoSpecialAttackDamage(Lua_Mob other, int skill, int64 max_damage, int64 min_damage) {
	Lua_Safe_Call_Void();
	self->DoSpecialAttackDamage(other, static_cast<EQ::skills::SkillType>(skill), max_damage, min_damage);
}

void Lua_Mob::DoSpecialAttackDamage(Lua_Mob other, int skill, int64 max_damage, int64 min_damage, int64 hate_override) {
	Lua_Safe_Call_Void();
	self->DoSpecialAttackDamage(other, static_cast<EQ::skills::SkillType>(skill), max_damage, min_damage, hate_override);
}

void Lua_Mob::DoSpecialAttackDamage(Lua_Mob other, int skill, int64 max_damage, int64 min_damage, int64 hate_override, int reuse_time) {
	Lua_Safe_Call_Void();
...
void Lua_Mob::RemoveFromHateList(Lua_Mob who) {
	Lua_Safe_Call_Void();
	self->RemoveFromHateList(who);
}
...
luabind::scope lua_register_mob() {
	return luabind::class_<Lua_Mob, Lua_Entity>("Mob")
		...
		.def("GotoBind", (void(Lua_Mob::*)(void))&Lua_Mob::GotoBind)
		.def("GotoBind", (void(Lua_Mob::*)(int))&Lua_Mob::GotoBind)
		...
		.def("GetDamageAmount", (uint64(Lua_Mob::*)(Lua_Mob))&Lua_Mob::GetDamageAmount)
		...
		.def("CheckAggroAmount", (int64(Lua_Mob::*)(int))&Lua_Mob::CheckAggroAmount)
		.def("CheckAggroAmount", (int64(Lua_Mob::*)(int,bool))&Lua_Mob::CheckAggroAmount)
		.def("CheckHealAggroAmount", (int64(Lua_Mob::*)(int))&Lua_Mob::CheckHealAggroAmount)
		.def("CheckHealAggroAmount", (int64(Lua_Mob::*)(int,uint64))&Lua_Mob::CheckHealAggroAmount)
		...
		.def("DoSpecialAttackDamage", (void(Lua_Mob::*)(Lua_Mob,int,int64))&Lua_Mob::DoSpecialAttackDamage)
		.def("DoSpecialAttackDamage", (void(Lua_Mob::*)(Lua_Mob,int,int64, int64))&Lua_Mob::DoSpecialAttackDamage)
		.def("DoSpecialAttackDamage", (void(Lua_Mob::*)(Lua_Mob,int,int64,int64,int64))&Lua_Mob::DoSpecialAttackDamage)
		.def("DoSpecialAttackDamage", (void(Lua_Mob::*)(Lua_Mob,int, int64, int64, int64, int))&Lua_Mob::DoSpecialAttackDamage)
