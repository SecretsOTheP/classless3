...
int64 Lua_StatBonuses::GetMaxHPChange() const {
	Lua_Safe_Call_Int();
...
int64 Lua_StatBonuses::GetHPToManaConvert() const {
	Lua_Safe_Call_Int();
...
int64 Lua_StatBonuses::GetPetMaxHP() const {
	Lua_Safe_Call_Int();
...
int64 Lua_StatBonuses::GetItemHPRegenCap() const {
	Lua_Safe_Call_Int();
...
int64 Lua_StatBonuses::GetHPPercCap(int idx) const {
	Lua_Safe_Call_Int();
