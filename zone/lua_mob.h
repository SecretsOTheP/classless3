...
public:
	...
	void WipeHateList(bool npc_only);
	...
	bool Charmed();
	int64 CheckAggroAmount(int spell_id);
	int64 CheckAggroAmount(int spell_id, bool is_proc);
	int64 CheckHealAggroAmount(int spell_id);
	int64 CheckHealAggroAmount(int spell_id, uint64 heal_possible);
	int GetAA(int id);
	...
	void DoSpecialAttackDamage(Lua_Mob other, int skill, int64 max_damage);
	void DoSpecialAttackDamage(Lua_Mob other, int skill, int64 max_damage, int64 min_damage);
	void DoSpecialAttackDamage(Lua_Mob other, int skill, int64 max_damage, int64 min_damage, int64 hate_override);
	void DoSpecialAttackDamage(Lua_Mob other, int skill, int64 max_damage, int64 min_damage, int64 hate_override, int reuse_time);
	...
	void RemoveFromHateList(Lua_Mob who);
