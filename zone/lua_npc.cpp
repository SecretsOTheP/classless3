...
void Lua_NPC::RescaleNPC(float value) {
	Lua_Safe_Call_Void();
	self->RescaleNPC(value);
}
...
void Lua_NPC::AddAISpell(int priority, int spell_id, int type, int mana_cost, int recast_delay, int resist_adjust, int64 min_hp, int64 max_hp) {
	Lua_Safe_Call_Void();
...
.def("AddAISpell", (void(Lua_NPC::*)(int, int, int, int, int, int, int64, int64))&Lua_NPC::AddAISpell)
...
.def("SetSimpleRoamBox", (void(Lua_NPC::*)(float, float))&Lua_NPC::SetSimpleRoamBox)
.def("SetSimpleRoamBox", (void(Lua_NPC::*)(float, float, int))&Lua_NPC::SetSimpleRoamBox)
.def("RescaleNPC", (void(Lua_NPC::*)(float))&Lua_NPC::RescaleNPC)
