...
void Lua_Client::SummonCursorItem(uint32 item_id) {
	Lua_Safe_Call_Void();
	self->SummonItem(item_id, -1, 0, 0, 0, 0, 0, 0, 0, EQ::invslot::slotCursor);
}

void Lua_Client::SummonCursorItem(uint32 item_id, int charges) {
	Lua_Safe_Call_Void();
	self->SummonItem(item_id, charges, 0, 0, 0, 0, 0, 0, 0, EQ::invslot::slotCursor);
}

void Lua_Client::SummonCursorItem(uint32 item_id, int charges, uint32 aug1) {
	Lua_Safe_Call_Void();
	self->SummonItem(item_id, charges, aug1, 0, 0, 0, 0, 0, 0, EQ::invslot::slotCursor);
}

void Lua_Client::SummonCursorItem(uint32 item_id, int charges, uint32 aug1, uint32 aug2) {
	Lua_Safe_Call_Void();
	self->SummonItem(item_id, charges, aug1, aug2, 0, 0, 0, 0, 0, EQ::invslot::slotCursor);
}

void Lua_Client::SummonCursorItem(uint32 item_id, int charges, uint32 aug1, uint32 aug2, uint32 aug3) {
	Lua_Safe_Call_Void();
	self->SummonItem(item_id, charges, aug1, aug2, aug3, 0, 0, 0, 0, EQ::invslot::slotCursor);
}

void Lua_Client::SummonCursorItem(uint32 item_id, int charges, uint32 aug1, uint32 aug2, uint32 aug3, uint32 aug4) {
	Lua_Safe_Call_Void();
	self->SummonItem(item_id, charges, aug1, aug2, aug3, aug4, 0, 0, 0, EQ::invslot::slotCursor);
}

void Lua_Client::SummonCursorItem(uint32 item_id, int charges, uint32 aug1, uint32 aug2, uint32 aug3, uint32 aug4, uint32 aug5) {
	Lua_Safe_Call_Void();
	self->SummonItem(item_id, charges, aug1, aug2, aug3, aug4, aug5, 0, 0, EQ::invslot::slotCursor);
}

void Lua_Client::SummonCursorItem(uint32 item_id, int charges, uint32 aug1, uint32 aug2, uint32 aug3, uint32 aug4, uint32 aug5, bool attuned) {
	Lua_Safe_Call_Void();
	self->SummonItem(item_id, charges, aug1, aug2, aug3, aug4, aug5, 0, attuned, EQ::invslot::slotCursor);
}

void Lua_Client::SummonCursorItem(uint32 item_id, int charges, uint32 aug1, uint32 aug2, uint32 aug3, uint32 aug4, uint32 aug5, bool attuned, int to_slot) {
	Lua_Safe_Call_Void();
	self->SummonItem(item_id, charges, aug1, aug2, aug3, aug4, aug5, 0, attuned, to_slot, EQ::invslot::slotCursor);
}
...
void Lua_Client::OutputAccountCharacters() {
	Lua_Safe_Call_Void();
	return self->OutputAccountCharacters();
}
...
luabind::scope lua_register_client() {
	return luabind::class_<Lua_Client, Lua_Mob>("Client")
		...
		.def("SummonCursorItem", (void(Lua_Client::*)(uint32,int,uint32))&Lua_Client::SummonCursorItem)
		.def("SummonCursorItem", (void(Lua_Client::*)(uint32,int,uint32,uint32))&Lua_Client::SummonCursorItem)
		.def("SummonCursorItem", (void(Lua_Client::*)(uint32,int,uint32,uint32,uint32))&Lua_Client::SummonCursorItem)
		.def("SummonCursorItem", (void(Lua_Client::*)(uint32,int,uint32,uint32,uint32,uint32))&Lua_Client::SummonCursorItem)
		.def("SummonCursorItem", (void(Lua_Client::*)(uint32,int,uint32,uint32,uint32,uint32,uint32))&Lua_Client::SummonCursorItem)
		.def("SummonCursorItem", (void(Lua_Client::*)(uint32,int,uint32,uint32,uint32,uint32,uint32,bool))&Lua_Client::SummonCursorItem)
		.def("SummonCursorItem", (void(Lua_Client::*)(uint32,int,uint32,uint32,uint32,uint32,uint32,bool,int))&Lua_Client::SummonCursorItem)
