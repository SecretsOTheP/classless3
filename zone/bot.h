...
public:
	...
	virtual void AddToHateList(Mob* other, int64 hate = 0, int32 damage = 0, bool iYellForHelp = true, bool bFrenzy = false, bool iBuffTic = false, bool pet_command = false);
	...
	virtual int GetRunspeed() { return (int)((float)_GetRunSpeed() * 1.785714285f); }
