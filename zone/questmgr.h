...
public:
	...
	Mob* spawn2(int npc_type, int grid, int unused, const glm::vec4& position, uint32 questgranter = 0);
	Mob* unique_spawn(int npc_type, int grid, int unused, const glm::vec4& position, uint32 questgranter = 0);
	Mob* spawn_from_spawn2(uint32 spawn2_id, uint32 questgranter = 0);
	...
	uint32 CreateInstance(const char *zone, int16 version, uint32 duration, uint32 group_id, int64 scale_cap = -1);
	uint32 CreateInstance(uint32 zone, int16 version, uint32 duration, uint32 group_id, int64 scale_cap = -1);
	void UpdateInstanceTimer(uint32 instance_id, uint32 new_duration);
	void UpdateZoneHeader(std::string type, std::string value);
	uint32 GetInstanceTimer();
	uint32 GetInstanceTimerByID(uint32 instance_id = 0);
	void DestroyInstance(uint32 instance_id);
	uint32 GetInstanceID(const char *zone, int16 version);
	void AssignToInstance(uint32 instance_id);
	void AssignToInstanceByCharID(uint32 instance_id, uint32 char_id);
	void AssignGroupToInstance(uint32 instance_id);
	void AssignRaidToInstance(uint32 instance_id);
	void RemoveFromInstance(uint32 instance_id);
	void RemoveFromInstanceByCharID(uint32 instance_id, uint32 char_id);
	uint32 CheckInstanceByGroupID(uint32 instance_id);
	//void RemoveGroupFromInstance(uint32 instance_id);	//potentially useful but not implmented at this time.
	//void RemoveRaidFromInstance(uint32 instance_id);	//potentially useful but not implmented at this time.
	void RemoveAllFromInstance(uint32 instance_id);
	...
	void CrossZoneMoveInstanceByCharID(int character_id, uint32 instance_id);
	void CrossZoneMoveInstanceByGroupID(int group_id, uint32 instance_id);
	void CrossZoneMoveInstanceByRaidID(int raid_id, uint32 instance_id);
	void CrossZoneMoveInstanceByGuildID(int guild_id, uint32 instance_id);
	...
	void WorldWideMoveInstance(uint32 instance_id, uint8 min_status = 0, uint8 max_status = 0);
