...
public:
	Spawn2(uint32 spawn2_id, uint32 spawngroup_id,
		...
		uint32 respawn, uint32 original_respawn, uint32 variance,
	...
	void	SetRespawnTimerForHotZone(uint32 newHotZoneBonus) {
		respawn_ = original_respawn_ / (newHotZoneBonus + 1);
	};
