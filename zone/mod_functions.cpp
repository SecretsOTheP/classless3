...
int64 Client::mod_bindwound_percent(int64 max_percent, Mob* bindmob) { return(max_percent); }

//Final bind HP value after bonuses
int64 Client::mod_bindwound_hp(int64 bindhps, Mob* bindmob) { return(bindhps); }
