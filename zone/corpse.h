...
class Corpse : public Mob {
	...
	Corpse(NPC* in_npc,/* ItemList* in_itemlist, */ uint32 in_npctypeid, const NPCType** in_npctypedata, Client* give_exp_client, uint32 in_decaytime = 600000, int aapts = 0);
	...
	virtual uint32		GetEquippedItemFromTextureSlot(uint8 material_slot) const;
